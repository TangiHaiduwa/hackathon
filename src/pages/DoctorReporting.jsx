...
const DoctorReporting = () => {
  ...
  const fetchDoctorData = async () => {
    try {
      ...
      setUser({
        ...
        department: doctorProfile.medical_staff?.[0]?.department_id?.department_name
      });
    } catch (error) {
  ...
  const generateCaseReport = () => {
    ...
    return `
      ...
      Date of Birth: ${reportContent.patientDOB} (Age: ${reportContent.patientAge})
      ...
      ${patientData.conditions?.map(cond => 
        `- ${cond.condition_id.condition_name} (Diagnosed: ${new Date(cond.diagnosis_date).toLocaleDateString()})`
      ...
      ${latestDiagnosis ? `
        ...
        Diagnosis Date: ${new Date(latestDiagnosis.diagnosis_date).toLocaleDateString()}
        Notes: ${latestDiagnosis.notes || 'None'}
      ` : 'No current diagnosis'}

      VITAL SIGNS (Latest):
      ${latestVitals ? `
        Blood Pressure: ${latestVitals.blood_pressure_systolic}/${latestVitals.blood_pressure_diastolic} mmHg
      ...
      CURRENT MEDICATIONS:
      ${patientData.prescriptions?.flatMap(prescription => 
  ...
  const generatePrescription = () => {
    ...
    return `
      ...
      IMPORTANT NOTES:
      ${reportContent.prescriptionNotes || 'Complete the full course of treatment'}
  ...
  const generateMedicalCertificate = () => {
    return `
      ...
      (Date of Birth: ${reportContent.patientDOB}) 
      was under my medical care from ${reportContent.certificateStartDate || '[Start Date]'} 
      to ${reportContent.certificateEndDate || '[End Date]'}.

      Type of Certificate: ${reportContent.certificateType || 'Medical Certificate'}

      Medical Condition:
      ${reportContent.certificateCondition || 'Medical condition requiring attention'}

      Recommendations:
      ${reportContent.certificateRecommendations || 'Patient is advised to follow medical recommendations'}
  ...
  const generateReferralLetter = () => {
    return `
      ...
      I am referring ${reportContent.patientName} (DOB: ${reportContent.patientDOB}) 
      ...
      ${reportContent.referralRequests || 'Please evaluate and manage accordingly'}
  ...
  const saveReport = async () => {
    ...
    try {
      ...
      const reportType = reportTemplates.find(t => t.type_code === activeReportType);
  ...
  const downloadReport = () => {
    ...
    element.download = `${reportTypes[activeReportType].name}_${selectedPatient.first_name}_${selectedPatient.last_name}_${new Date().toISOString().split('T')[0]}.txt`;
  ...
  const renderPatientSelection = () => (
    <div className="card-medical">
      <div className="px-6 py-4 border-b">
        ...
        <p className="text-sm text-gray-600">Choose a patient to generate reports</p>
      </div>
      <div className="p-6">
      ...
      <div className="card-medical">
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, assessment: e.target.value }))}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, recommendations: e.target.value }))}
                  className="input-medical"
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, medications: e.target.value }))}
                  className="input-medical"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, instructions: e.target.value }))}
                  className="input-medical"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, certificateType: e.target.value }))}
                  className="input-medical"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, certificatePurpose: e.target.value }))}
                  className="input-medical"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, certificateStartDate: e.target.value }))}
                  className="input-medical"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, certificateEndDate: e.target.value }))}
                  className="input-medical"
                />
              </div>
            </div>
          ...
          {activeReportType === 'referral' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Specialist Type</label>
                <select
                  value={reportContent.referralSpecialist || ''}
                  onChange={(e) => setReportContent(prev => ({ ...prev, referralSpecialist: e.target.value }))}
                  className="input-medical"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, referralFacility: e.target.value }))}
                  className="input-medical"
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) => setReportContent(prev => ({ ...prev, referralReason: e.target.value }))}
                  className="input-medical"
            ...
            <div key={report.id} className="border rounded-lg p-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm text-gray-600">{report.report_type_id.type_name}</p>
    ...
    <DashboardLayout user={user} navigation={navigation}>
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Medical Reporting</h1>
