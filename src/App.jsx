      ...
      <Router>
        <div className="App">
          <Routes>
            ...
            <Route path="/nurse-treatmentroom" element={<TreatmentRoomPage />}/>
            <Route path="/nurse-vitals" element={<Vitals />}/>
            <Route path="/patient-rounds" element={<PatientRoundsPage />}/>
            <Route path="/medical-records" element={<MedicalRecordsPage />}/>

            {/* Receptionist Modules */}
            <Route path="/receptionist/receptionist-appointments" element={<ReceptionistAppointments />}/>
            ...
            <Route path="/reception/medical-records1" element={<MedicalRecordsPage1 />}/>


            {/* Pharmacy Modules */}
            <Route path="/pharmacy/prescriptions" element={<PrescriptionsList />} />
            <Route path="/pharmacy/inventory" element={<InventoryManagement />} />
            <Route path="/pharmacy/dispensing" element={<DispensingManagement />} />
            <Route path="/pharmacy/reports" element={<PharmacyReports />} />
            <Route path="/pharmacy/administration" element={<DrugAdministration />} />
            <Route path="/pharmacy/dispensing-workflow" element={<DispensingWorkflow />} />
            ...
            <Route path="/medical-records-admin" element={<MedicalRecordsAdmin />} />
            <Route path="/pharmacy-admin" element={<PharmacyManagement />} />
            <Route path="/appointments-admin" element={<AppointmentManagement />} />
